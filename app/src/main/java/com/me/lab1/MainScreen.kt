...
import com.me.lab1.ui.theme.DEFAULT_PADDING
import com.me.lab1.ui.theme.FluidBottomNavigationTheme
import com.me.lab1.ui.theme.Pink
...
fun MainScreen() {
    ...
    val fabAnimationProgress = animateFloatAsState(
    ...
    val clickAnimationProgress = animateFloatAsState(
        targetValue = if (isMenuExtended.value) 1f else 0f,
        animationSpec = tween(
            durationMillis = 400,
            easing = LinearEasing
